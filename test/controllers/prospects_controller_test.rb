...
class ProspectsControllerTest < ActionController::TestCase
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post :create, prospect: { college: @prospect.college, notes: @prospect.notes, overall_ranking: @prospect.overall_ranking, player: @prospect.player, position: @prospect.position, positional_ranking: @prospect.positional_ranking }
    end
  ...
  test "should update prospect" do
    patch :update, id: @prospect, prospect: { college: @prospect.college, notes: @prospect.notes, overall_ranking: @prospect.overall_ranking, player: @prospect.player, position: @prospect.position, positional_ranking: @prospect.positional_ranking }
    assert_redirected_to prospect_path(assigns(:prospect))
  end
